...
const Input = ({label, type, value, placeholder, handleChange, error, required}) => {
    ...
    return (
        <section className="flex justify-center py-0.5">
            <div className="py-4 bg-amber-50 px-5 rounded">
                ...
                <input className="border-2 border-amber-100 rounded w-[600px] p-1 focus:outline-none focus:border-amber-400 required:border-red-300" type={type} value={value} placeholder={placeholder} onChange={handleChange} required={required}/>
